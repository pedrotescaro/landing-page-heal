   ...
   <div class="container header-container">
        ...
        <div class="flex items-center gap-4 relative z-50">
            ...
            <div class="flex items-center gap-2">
                <img src="assets/imgs/Logo_Heal4.png" alt="Heal Logo" class="w-12 object-contain">
        ...
        <nav class="nav-links" id="navLinks">
              <button id="toggleDarkMode" class="rounded-full p-2 shadow transition-colors duration-200 focus:ring-2 focus:ring-sky-400 outline-none
...
<section id="feedback" class="container mx-auto px-4 mb-32">
    <div class="max-w-2xl mx-auto">
        <h2 class="text-3xl font-bold mb-8 text-center text-sky-600" data-i18n="feedback.title">Your Opinion is Essential</h2>
        <form class="space-y-6 rounded-2xl p-6 border border-sky-200 shadow-lg">
            <div>
                <label for="feedback-type" id="feedback-type-label" class="block text-sm font-medium mb-2 text-white-800" data-i18n="feedback.typeLa
                <select id="feedback-type-select" class="w-full px-4 py-3 rounded-lg bg-blue border border-sky-300 focus:ring-2 focus:ring-sky-400 f
                    <option id="feedback-option-suggestion" data-i18n="feedback.options.suggestion">Suggestion</option>
                    <option id="feedback-option-problem" data-i18n="feedback.options.problem">Problem</option>
                    <option id="feedback-option-praise" data-i18n="feedback.options.praise">Praise</option>
                    <option id="feedback-option-other" data-i18n="feedback.options.other">Other</option>
                </select>
            </div>
            <div>
                <label for="feedback-message" id="feedback-message-label" class="block text-sm font-medium mb-2 text-white-800" data-i18n="feedback.
                <textarea id="feedback-message" rows="4" required class="w-full px-4 py-3 rounded-lg bg-white border border-sky-300 focus:ring-2 foc
            </div>
            <button id="feedback-submit" type="submit"
                class="w-full py-3 px-6 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white rounded-lg font-se
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#depoimentos" class="text-gray-300 hover:text-sky-300 transition-colors" data-i18n="footer.links.testimonials"></a>
...
<div id="downloadModal" class="hidden fixed inset-0 z-50 bg-black/50 backdrop-blur-sm">
    ...
    <!-- Font Size Controls -->
    <div class="flex flex-col gap-2 fixed right-3 top-40 z-50">
      <button class="js-increase-font-size text-white bg-[#1F71D0] border border-solid white/50 hover:bg-white hover:text-[#1F71D0] hover:border-[#1F71D0]/50 transition-colors duration-300 h-[40px] rounded w-[40px] px-2 text-2xl flex justify-center">+</button>
      <button class="js-decrease-font-size text-white bg-[#1F71D0] border border-solid white/50 hover:bg-white hover:text-[#1F71D0] hover:border-[#1F71D0]/50 transition-colors duration-300 h-[40px] rounded w-[40px] text-2xl flex justify-center">-</button>
    </div>
    ...
    <script src="assets/js/script-geral.js"></script>
    <script src="assets/js/script-mododark.js"></script>
...
>>>>>>> c1a3d80f50247da11fa330fe0bc1d18520a62fa6:index.php
</html>